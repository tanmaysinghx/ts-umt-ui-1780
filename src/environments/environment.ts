...
export const environment = {
  ...
  apiGatewayService: 'http://localhost:1606/api/v1/api-engine/trigger-workflow',  // API Gateway Workflow Endpoint
  ssoGoogleUrl: 'http://localhost:1625/v2/api/auth/oauth2/authorization/google',
